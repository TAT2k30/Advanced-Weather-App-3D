...
const RenderCountry: React.FC = () => {
    ...
    useEffect(() => {
        const loadCountry = () => {
            ...
            const coordinates =
                countryData.geometry.type === "MultiPolygon"
...
const RenderCountryCanvas: React.FC = () => {
        ...
        <div className="relative w-screen h-screen bg-gradient-to-br from-blue-600 to-purple-800 text-white">
            ...
            <div className="absolute inset-0 flex items-center justify-center p-4">
                <div className="bg-white text-black p-6 rounded-lg shadow-xl w-[90%] max-w-lg">
                    ...
                    <div className="m-4 inset-0 flex items-center justify-center">
                        <div className="w-full h-[300px] p-4 bg-gray-900 rounded-lg shadow-lg">
                            <RenderCountryCanvas />
                        </div>
                    </div>
