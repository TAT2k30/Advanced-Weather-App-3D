          ...
          <ul
            ...
            <li className='max-lg:border-b max-lg:py-3 px-3 flex items-center gap-2'>
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div className="w-14 h-7 bg-gray-200 rounded-full peer dark:bg-gray-700 peer-checked:bg-blue-600 transition duration-300 ease-in-out">
                  <div className="absolute w-6 h-6 bg-white rounded-full top-0.5 left-0.5 peer-checked:translate-x-7 transition-transform duration-300 ease-in-out"></div>
                </div>
              </label>
            </li>
