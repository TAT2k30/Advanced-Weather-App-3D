    ...
    return (
        <div className=" top-4 left-4 right-4 flex justify-between items-center">
            ...
            <div className="flex bg-white rounded-full pt-2 pb-2 pl-5">
                ...
                {/* Thanh tìm kiếm */}
                <div className="flex items-center w-full max-w-lg mx-4 space-x-3">
                    {/* Input search */}
                    <input
                        type="text"
                        placeholder="Search for country ..."
                        className="flex-grow px-4 py-4 text-gray-700 bg-gray-200 rounded-full shadow-inner focus:outline-none"
                    />
                    {/* Button search */}
                    <button className="p-3 bg-[#fb923c] text-white rounded-full hover:bg-[#ea580c] transition">
                        <svg
